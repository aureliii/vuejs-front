<template>
    <div>
        ...
        <div ref="bmBurgerButton" class="bm-burger-button" @click="openMenu" :class="{ hidden: !burgerIcon }">
            <span class="bm-burger-bars line-style" :style="{top:20 * (index * 2) + '%'}" v-for="(x, index) in 3" :key="index">             
            </span>
        </div>
    </div>
</template>
    ...
    export default {
      ...
      data: () => ({ 
        ...
        items: [
            ...
            { title: 'Log Out', icon: 'mdi-help-box',action: "logout"},
            ],
...
<style>
    ...
    .bm-menu {
      ...
      top: 0;
      left: 0;
      background-color: rgb(233, 233, 241); /* Black*/
